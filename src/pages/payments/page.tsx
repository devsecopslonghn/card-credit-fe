...
export default function PaymentsPage() {
  ...
  return <main className="cc-page min-h-screen px-4 py-8 md:px-8"><div className="mx-auto max-w-6xl">
    <header className="mb-8 flex justify-between gap-4"><div><p className="text-xs font-bold uppercase tracking-widest text-[#23899a]">PAYMENTS</p><h1 className="mt-2 text-3xl font-bold cc-text-primary">Thanh toán</h1><p className="mt-1 cc-text-muted">Theo dõi các kỳ sao kê cần trả và lịch sử thanh toán.</p></div><Link to="/cards" className="cc-control h-fit rounded-lg px-4 py-2 text-sm font-semibold">Dashboard</Link></header>
