...
export default function DashboardPage() {
  ...
  return <FinanceShell title="Tổng quan" action={<Link to="/transactions?add=1" className="rounded-lg bg-[#087f83] px-4 py-2.5 font-semibold text-white">+ Thêm giao dịch</Link>}>
