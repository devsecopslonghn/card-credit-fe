  ...
  return (
    <article className={`rounded-xl border p-5 ${tone}`} aria-label="Khoản thanh toán ưu tiên">
      ...
      <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:justify-end">
        <Link to={`/cards/${card._id}`} className="rounded-lg border cc-border bg-surface px-4 py-2.5 text-center text-sm font-semibold cc-text-muted hover:bg-surface-elevated">Xem chi tiết</Link>
